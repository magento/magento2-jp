...
define([
     ...
     * @return {String}
     */
    var buildApiUrl = function (postalCode) {
     ...
     * @return {Promise}
     */
    var callApi = function (postalCode) {
     ...
     */
    var mapServiceData = function (serviceData) {
        return {
     ...
     * @return {Promise}
     */
    var getPostalCodeData = function (postalCode, lang)
    {
